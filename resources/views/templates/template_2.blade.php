                ...
                <div class="certificate p-3">
                    <div class="card cert-cont">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="name monsieur-la-doulaise-regular">[Juan Dela Cruz Santiago]</p>

                            <p>For participating in the <i>[Event Name]</i></p>
                            <p>held by Laguna State Polytechnic University San Pablo City Campus on [Event Date]</p>
                            <div class="d-flex justify-content-around mt-5">
                                <div>
                                    ...
                                    <p style="color: goldenrod;">Signatory 1 Position/Designation</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p style="color: goldenrod;">Signatory 2 Position/Designation</p>
                                </div>
                            </div>
                            <div class="d-flex justify-content-around ">
                                <div>
                                    <img src="{{ asset('assets/img/signature.png') }}" alt="" srcset="" style="max-height:40px; margin-bottom: -30px;">
                                    <p class="m-0">_________________</p>
                                    <p class="m-0" style="font-weight: bold;">Signatory 3</p>
                                    <p style="color: goldenrod;">Signatory 3 Position/Designation</p>
                                </div>
